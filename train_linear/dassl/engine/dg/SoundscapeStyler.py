...
class SoundscapeStyler(nn.Module):
    def __init__(self, cfg, classnames, clip_model, device):
        ...
        self.weight_save_path = os.path.join(cfg.TRAINER.SOUNDSCAPE.WEIGHT_DIR_PATH,
                                             cfg.TRAINER.SOUNDSCAPE.CHECK_POINT_NAME)
        # raw template: this is a sound of 
        self.prompt_style_template = "a sound of of X"
        ...
        # raw template: a sound of of X in CLS
        self.init_template(self.classnames, "a sound of of X in CLS")
        ...
        self.train_flag = cfg.TRAINER.SOUNDSCAPE.TRAIN_STYLE
    ...
    def forward(self, style_idx):
        ...
        acoustic_loss_dj = -torch.log(per_zimm.diag()).mean()

        return style_diversity_loss, acoustic_loss_dj

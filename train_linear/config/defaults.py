...
###########################
# Optimization for diverse net
###########################

_C.OPTIM_DIVERSE = CN()
_C.OPTIM_DIVERSE.NAME = "adam"
_C.OPTIM_DIVERSE.LR = 0.0003
_C.OPTIM_DIVERSE.WEIGHT_DECAY = 5e-4
_C.OPTIM_DIVERSE.MOMENTUM = 0.9
_C.OPTIM_DIVERSE.SGD_DAMPNING = 0
_C.OPTIM_DIVERSE.SGD_NESTEROV = False
_C.OPTIM_DIVERSE.RMSPROP_ALPHA = 0.99
# The following also apply to other
# adaptive optimizers like adamw
_C.OPTIM_DIVERSE.ADAM_BETA1 = 0.9
_C.OPTIM_DIVERSE.ADAM_BETA2 = 0.999
# STAGED_LR allows different layers to have
# different lr, e.g. pre-trained base layers
# can be assigned a smaller lr than the new
# classification layer
_C.OPTIM_DIVERSE.STAGED_LR = False
_C.OPTIM_DIVERSE.NEW_LAYERS = ()
_C.OPTIM_DIVERSE.BASE_LR_MULT = 0.1
# Learning rate scheduler
_C.OPTIM_DIVERSE.LR_SCHEDULER = "single_step"
# -1 or 0 means the stepsize is equal to max_epoch
_C.OPTIM_DIVERSE.STEPSIZE = (-1,)
_C.OPTIM_DIVERSE.GAMMA = 0.1
_C.OPTIM_DIVERSE.MAX_EPOCH = 10
# Set WARMUP_EPOCH larger than 0 to activate warmup training
_C.OPTIM_DIVERSE.WARMUP_EPOCH = -1
# Either linear or constant
_C.OPTIM_DIVERSE.WARMUP_TYPE = "linear"
# Constant learning rate when type=constant
_C.OPTIM_DIVERSE.WARMUP_CONS_LR = 1e-5
# Minimum learning rate when type=linear
_C.OPTIM_DIVERSE.WARMUP_MIN_LR = 1e-5
# Recount epoch for the next scheduler (last_epoch=-1)
# Otherwise last_epoch=warmup_epoch
_C.OPTIM_DIVERSE.WARMUP_RECOUNT = True
###########################
# Train
###########################
_C.TRAIN = CN()
...
_C.STYLE_GENERATOR = CN()
_C.STYLE_GENERATOR.NAME = "MixStyleGenerator"
_C.STYLE_GENERATOR.STYLE_TXT_PATH = "dassl/txts/style.txt"
_C.STYLE_GENERATOR.ENABLE_DIVERSE = False

_C.TRAINER.SOUNDSCAPE = CN()
_C.TRAINER.SOUNDSCAPE.WEIGHT_DIR_PATH = "weight/SOUNDSCAPE/checkpoint"
_C.TRAINER.SOUNDSCAPE.CHECK_POINT_NAME = "model.pth"
_C.TRAINER.SOUNDSCAPE.TRAIN_STYLE = False
